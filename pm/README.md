...
> 单一事实源：[`project.config.json`](../project.config.json) + [`tasks/tasks.json`](./tasks/tasks.json)（96 个任务）。
...
- 覆盖周次：W1–W2
- 里程碑：可离线、CLI/MCP 可交付、商业化文档定稿
- 准出闸门：网页离线 zip 可跑 + npm test 全绿 + 架构门 NONE

### Phase 1 · CLI/网页获客并行

- 覆盖周次：W3–W6
- 里程碑：npm/CLI 可安装 + 落地页上线 + 首批试用
- 准出闸门：setup 一键接入可用 + Free/Pro 门禁可演示（CLI/网页）
...
| [W02](./tasks/W02/README.md) | 网页离线包 / 冒烟清单 / 账号骨架（扩展暂缓） | 2026-09-11 | 6 | 5/6 | ⚠️逾期 |
...
| [W06](./tasks/W06/README.md) | 落地页 / npm 分发 / 冲榜（Marketplace 暂缓） | 2026-10-09 | 4 | 2/4 | 🟢正常 |
| [W07](./tasks/W07/README.md) | 增量生成引擎 / architecture-rules.yaml | 2026-10-16 | 2 | 2/2 | ✅完成 |
| [W08](./tasks/W08/README.md) | CI Action 漂移检测 + PR 评论 | 2026-10-23 | 3 | 2/3 | 🟢正常 |
| [W09](./tasks/W09/README.md) | 付费转化优化 / 首笔 Pro | 2026-10-30 | 3 | 2/3 | 🟢正常 |
| [W10](./tasks/W10/README.md) | 多语言漂移精度打磨 / PR 评论 v2 | 2026-11-06 | 2 | 2/2 | ✅完成 |
