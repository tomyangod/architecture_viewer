# W06 任务卡 · 双 Marketplace 上架 / 落地页 / 冲榜
...
| 工时预估 | 4h |
| 截止 | 2026-10-09 |
| 依赖 | [W02-01](../W02/README.md#w02-01)、[W03-02](../W03/README.md#w03-02)、[W04-02](../W04/README.md#w04-02) |
| 负责人 | heyangyan |
| 标签 | release / milestone |


**背景**：Open VSX 覆盖 Cursor 用户；两市场都过审才算 Phase 1 交付。国庆缓冲允许滑至 10-16。

**目标**：扩展在两个市场可搜索、可安装；publisher 验证完成。
...
| 工时预估 | 2h |
| 截止 | 2026-10-09 |
| 依赖 | [W06-01](../W06/README.md#w06-01)、[W04-04](../W04/README.md#w04-04) |
| 负责人 | heyangyan |
| 标签 | metrics |


**背景**：周报需要安装/激活数据支撑转化率判断；Marketplace 后台 + 遥测双来源。
