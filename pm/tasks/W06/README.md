...
**涉及文件**：`pm/metrics.md` `pm/scripts/metrics-pull.mjs` `pm/scripts/wbs-report.mjs`
...
**活动记录**：
  - 2026-09-05 状态变更 todo→doing：补齐 metrics 口径与首周 npm 实数
  - 2026-09-05 状态变更 doing→done：metrics.md 口径+首周 npm 375；metrics-pull.mjs；周报 §六引用拉取命令
