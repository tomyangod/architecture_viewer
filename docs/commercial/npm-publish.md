...
# 2. 看将打进包的文件（不应含 docs/demos/demo.mp4、archify-main、.data）
npm pack --dry-run
...
必须含 `mcp/`（setup / `arch-viewer-mcp`）、套件图源 6 个 `.md`、`templates/`、`docs/guides/welcome.html`。不要把 `eval/`、`pm/`、`docs/demos/demo.mp4`、`.data/` 打进去。
