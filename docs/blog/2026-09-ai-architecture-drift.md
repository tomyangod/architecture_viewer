...
| 平台 | 链接 | 状态 |
|------|------|------|
| **GitHub / Gitee README** | [仓库 README](https://gitee.com/heyangyan/architecture_viewer) · [本文源文件](https://gitee.com/heyangyan/architecture_viewer/blob/main/docs/blog/2026-09-ai-architecture-drift.md) · [GitHub 镜像](https://github.com/heyangyan/architecture_viewer) | 已入库，随仓库公开 |
...
它不依赖 LLM 也能出图与出报告（tree-sitter 静态解析）；精修、托管评论是可选 Pro 层。Community 能力按 [COMMERCIAL.md](../../COMMERCIAL.md) **永不电检许可证**。
...
新手若被术语卡住，先看 [会话验收指南](../SESSION-GUIDE.md)（大白话）或 [小白攻略](../beginner-guide/index.html)。
...
一句话：**出图是诱饵，漂移红灯才是订阅理由。** Community 不会把「单次 Generate 次数」做成付费墙。细节见 [COMMERCIAL.md](../../COMMERCIAL.md)。
...
- 商业边界：仓库根目录 `COMMERCIAL.md`  
- 本地 Pro 说明：`docs/PRO-LOCAL.md`  
- 本文源文件：`docs/blog/2026-09-ai-architecture-drift.md`
