(function () {
  ...
  var I18N = {
    zh: {
      ...
      'product.extBody': '<code>npm i -g architecture-viewer</code>。Init → Generate → check --drift。图落在仓库里，跟 PR 一起 review。',
    ...
    en: {
      ...
      'product.extBody': '<code>npm i -g architecture-viewer</code>. Init → Generate → check --drift. Diagrams land in the repo and review with the PR.',
