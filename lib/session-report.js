 ...
 */
function generateReport({ baseGraph, headGraph, diff, findings, impact, repoName, sessionStart, analyzerStatus, analysisCompleteness }) {
  const payload = buildReportData(baseGraph, headGraph, diff, findings, impact, repoName, sessionStart, analysisCompleteness);
 ...
 */
function buildReportData(baseGraph, headGraph, headDiff, findings, impact, repoName, sessionStart, analysisCompleteness) {
...
function buildSessionReportJson({ diff, findings, riskSummary, impact, baseGraph, headGraph, repoName, analyzerStatus, analysisCompleteness }) {
  const list = findings || [];
  const risk = {
  ...
  if (canView) {
    const view = buildReportData(
      ...
      payload.repo || 'repo', payload.sessionStart, analysisCompleteness
    );
