...
function scan(root) {
  ...
  const entrypoints = [];
  for (const f of ['main.py', 'app.py', 'index.html', 'dashboard.html', 'valuation_monitor.py', 'server.js', 'main.go', 'manage.py', 'scheduler.py', 'worker.py', 'Cargo.toml', 'src/main.rs', 'src/lib.rs', 'cli.js', 'index.js', 'package.json', 'pom.xml', 'build.gradle', 'src/main/java']) {
