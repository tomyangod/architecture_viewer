...
const C4_DECL = /(?:Person|Person_Ext|Container|System_Ext|ContainerDb|System|Component|ComponentDb|ContainerQueue|Container_Boundary|System_Boundary|Enterprise_Boundary)\s*\(\s*([A-Za-z_][\w]*)/g;
