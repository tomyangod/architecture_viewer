...
> **当前试点版：`0.12.2-rc.4`（npm 标签 `next`；`latest` 仍为 `0.12.1`）。** 接入请钉 `arch-viewer@0.12.2-rc.4` 或 `@next`，不要与工作区源码或 `latest` 混用。发布记录与源提交见 [docs/commercial/npm-publish.md](docs/commercial/npm-publish.md)。这是有明确边界的本地试点候选，不是稳定商用版。
